...
> 详细流程见 `references/claude-md-generation.md`

在规划阶段完成后，自动生成 `CLAUDE.md` — 这是给 AI 看的「项目说明书」。

**关键约束**：
- **只执行一次** — 通过 `.claude-md-generated` 标记文件判断，后续调用不重复生成
- **已有则补充** — 如果 CLAUDE.md 已存在，追加缺失章节，不覆盖原有内容
- **产品经理思维** — 用户可能不懂技术、描述模糊、用词不专业，AI 需要理解真实意图后翻译成技术语言写入

**执行时机**：
- 全新项目 → 1.4 之后生成
- 已有项目 → 1.3 扫描模板后补充

**CLAUDE.md 包含**：项目背景、技术栈、目录结构、核心功能、开发规范、特殊说明、用户偏好
